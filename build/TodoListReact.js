...
*/
var aa=__webpack_require__(23),ba=__webpack_require__(0),m=__webpack_require__(45),p=__webpack_require__(22),v=__webpack_require__(17),da=__webpack_require__(46),ea=__webpack_require__(47),fa=__webpack_require__(48),ha=__webpack_require__(24);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(25)(Function.call, __webpack_require__(58).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var _TodoApp = __webpack_require__(128);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

(0, _reactDom.render)(React.createElement(_TodoApp.TodoApp, null), document.querySelector('#TodoAppReact'));
...
var _TodoTitle = __webpack_require__(139);

var _SearchPanel = __webpack_require__(141);

var _TodoItemStatusFilter = __webpack_require__(143);

var _TodoList = __webpack_require__(145);

var _TodoItemAddForm = __webpack_require__(150);
...
var TodoApp = exports.TodoApp = function (_Component) {
    ...
    function TodoApp() {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (TodoApp.__proto__ || Object.getPrototypeOf(TodoApp)).call(this));

        _this.maxId = 100;
        _this.state = {
            todoData: [_this.createTodoItem('Learn HTML'), _this.createTodoItem('Learn CSS'), _this.createTodoItem('Learn JS'), _this.createTodoItem('Learn React'), _this.createTodoItem('Build Awesome App'), _this.createTodoItem('Find New Job'), _this.createTodoItem('Quit Old Work'), _this.createTodoItem('Become The Best Developer')],
            term: '',
            filter: 'all'
        };
        ...
        _this.deleteItem = function (id) {
            _this.setState(function (_ref) {
                var todoData = _ref.todoData;

                var idx = todoData.findIndex(function (el) {
                    return el.id === id;
                });

                var newArray = [].concat((0, _toConsumableArray3.default)(todoData.slice(0, idx)), (0, _toConsumableArray3.default)(todoData.slice(idx + 1)));
        ...
        _this.addItem = function (text) {
            ...
            _this.setState(function (_ref2) {
                var todoData = _ref2.todoData;


                var newArr = [].concat((0, _toConsumableArray3.default)(todoData), [newItem]);
        ...
        _this.onToggleImportant = function (id) {
            _this.setState(function (_ref3) {
                var todoData = _ref3.todoData;

                var idx = todoData.findIndex(function (el) {
                    return el.id === id;
                });

                var oldItem = todoData[idx];
                var newItem = (0, _extends3.default)({}, oldItem, { important: !oldItem.important });

                var newArray = [].concat((0, _toConsumableArray3.default)(todoData.slice(0, idx)), [newItem], (0, _toConsumableArray3.default)(todoData.slice(idx + 1)));
        ...
        _this.onToggleDone = function (id) {
            _this.setState(function (_ref4) {
                ...
                var oldItem = todoData[idx];
                var newItem = (0, _extends3.default)({}, oldItem, { done: !oldItem.done });
        ...
        _this.search = function (items, term) {
        ...
        _this.filter = function (items, filter) {
            switch (filter) {
                case 'all':
                    return items;
                case 'active':
    ...
    (0, _createClass3.default)(TodoApp, [{
        ...
        value: function render() {
            var _state = this.state,
                todoData = _state.todoData,
                term = _state.term,
                filter = _state.filter;

            var visibleItems = this.filter(this.search(todoData, term), filter);
            var doneCount = todoData.filter(function (el) {
                return el.done;
            }).length;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_TodoTitle.TodoTitle, { toDo: todoCount, done: doneCount }),
                _react2.default.createElement(
                    'div',
                    { className: 'Todo-panel' },
                    _react2.default.createElement(_SearchPanel.SearchPanel, {
                        onSearchChange: this.onSearchChange
                    }),
                    _react2.default.createElement(_TodoItemStatusFilter.TodoItemStatusFilter, {
                        filter: filter,
                ...
                _react2.default.createElement(_TodoItemAddForm.TodoItemAddForm, { onItemAdded: this.addItem })
            );
        }
    }]);
    return TodoApp;
...
var TodoTitle = exports.TodoTitle = function (_React$Component) {
    (0, _inherits3.default)(TodoTitle, _React$Component);

    function TodoTitle() {
        (0, _classCallCheck3.default)(this, TodoTitle);
        return (0, _possibleConstructorReturn3.default)(this, (TodoTitle.__proto__ || Object.getPrototypeOf(TodoTitle)).call(this));
    }

    (0, _createClass3.default)(TodoTitle, [{
        key: 'render',
        value: function render() {
...
var searchText = 'Type here to search';

var SearchPanel = exports.SearchPanel = function (_React$Component) {
    (0, _inherits3.default)(SearchPanel, _React$Component);

    function SearchPanel() {
        (0, _classCallCheck3.default)(this, SearchPanel);

        var _this = (0, _possibleConstructorReturn3.default)(this, (SearchPanel.__proto__ || Object.getPrototypeOf(SearchPanel)).call(this));
...
exports.TodoItemStatusFilter = undefined;
...
var TodoItemStatusFilter = exports.TodoItemStatusFilter = function (_React$Component) {
    (0, _inherits3.default)(TodoItemStatusFilter, _React$Component);

    function TodoItemStatusFilter() {
        (0, _classCallCheck3.default)(this, TodoItemStatusFilter);

        var _this = (0, _possibleConstructorReturn3.default)(this, (TodoItemStatusFilter.__proto__ || Object.getPrototypeOf(TodoItemStatusFilter)).call(this));

        _this.buttons = [{ name: 'all', label: 'All' }, { name: 'active', label: 'Active' }, { name: 'done', label: 'Done' }];
        return _this;
    }

    (0, _createClass3.default)(TodoItemStatusFilter, [{
        key: 'render',
        value: function render() {
            var _props = this.props,
            ...
            var buttons = this.buttons.map(function (_ref) {
                var name = _ref.name,
                    label = _ref.label;

                var isActive = filter === name;
                var clazz = isActive ? 'status-button__btn-active' : 'status-button__btn';
                return React.createElement(
                    'button',
                    { className: 'status-button__btn ' + clazz, key: name,
                        onClick: function onClick() {
                            return onFilterChange(name);
                        } },
                    label
                );
            });
...
var _TodoListItems = __webpack_require__(148);
...
var TodoList = exports.TodoList = function (_React$Component) {
    ...
    function TodoList() {
        ...
        return (0, _possibleConstructorReturn3.default)(this, (TodoList.__proto__ || Object.getPrototypeOf(TodoList)).apply(this, arguments));
    }
    ...
    (0, _createClass3.default)(TodoList, [{
        ...
        value: function render() {
            var _props = this.props,
                todos = _props.todos,
                _onDeleted = _props.onDeleted,
                _onToggleImportant = _props.onToggleImportant,
                _onToggleDone = _props.onToggleDone;


            var elements = todos.map(function (item) {
                var id = item.id,
                    itemProps = (0, _objectWithoutProperties3.default)(item, ['id']);

                return React.createElement(
                    'li',
                    { className: 'Todo-list-item', key: id },
                    React.createElement(_TodoListItems.TodoListItems, (0, _extends3.default)({}, itemProps, {
                        onDeleted: function onDeleted() {
                            return _onDeleted(id);
                        },
                        onToggleImportant: function onToggleImportant() {
                            return _onToggleImportant(id);
                        },
                        onToggleDone: function onToggleDone() {
                            return _onToggleDone(id);
                        }
                    }))
                );
            });
...
exports.TodoListItems = undefined;
...
var TodoListItems = exports.TodoListItems = function (_React$Component) {
    (0, _inherits3.default)(TodoListItems, _React$Component);

    function TodoListItems() {
        (0, _classCallCheck3.default)(this, TodoListItems);
        return (0, _possibleConstructorReturn3.default)(this, (TodoListItems.__proto__ || Object.getPrototypeOf(TodoListItems)).apply(this, arguments));
    }

    (0, _createClass3.default)(TodoListItems, [{
        key: 'render',
        value: function render() {
            var _props = this.props,
                label = _props.label,
                onToggleImportant = _props.onToggleImportant,
                onToggleDone = _props.onToggleDone,
                done = _props.done,
                important = _props.important;

            var classNames = 'Todo-list-wrapper';
            if (done) {
                classNames += ' done';
            }
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'button',
                        { className: 'Todo-list-button__btn Todo-list-button__danger ', onClick: this.props.onDeleted },
                        React.createElement('i', { className: 'fas fa-trash-alt' })
                    ),
                    React.createElement(
                        'button',
                        { className: 'Todo-list-button__btn Todo-list-button__success', onClick: onToggleImportant },
...
exports.TodoItemAddForm = undefined;
...
var TodoItemAddForm = exports.TodoItemAddForm = function (_React$Component) {
    (0, _inherits3.default)(TodoItemAddForm, _React$Component);

    function TodoItemAddForm() {
        (0, _classCallCheck3.default)(this, TodoItemAddForm);

        var _this = (0, _possibleConstructorReturn3.default)(this, (TodoItemAddForm.__proto__ || Object.getPrototypeOf(TodoItemAddForm)).call(this));
        ...
        _this.onSubmit = function (e) {
            e.preventDefault();
            _this.props.onItemAdded(_this.state.label);
            _this.setState({
                label: ''
            });
        };
    ...
    (0, _createClass3.default)(TodoItemAddForm, [{
        key: 'render',
        value: function render() {
            return React.createElement(
                'form',
                { className: 'Todo-item-add-form',
                ...
                React.createElement(
                    'button',
                    { className: 'Todo-item-add-form__btn' },
                    'Add Item'
                )
            );
        }
    }]);
    return TodoItemAddForm;
}(React.Component);
